...
seznam_kw = [["Keywords"], ["inflace"], ["inflation"], ["prices"] ]
...
import time
startTime = time.time()
pytrend = TrendReq(hl='en-US', tz=360)  # tady je jazyk - en-GB je birtska anglictina, en-US americka
...
for x in range(0,len(df2)):
     ...
     geo='GB') # geopoliticka oblast, GB je Velka Britanie, US Spojene Staty
